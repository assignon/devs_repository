    ...
    <v-layout row rwo-wrap align-center justify-center class="contact-layout">
        <v-flex xs12 sm12 md6 lg6 xl6 class="map-flex">
            <div class="map-container">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d39032.8801596525!2d4.648319085932059!3d52.30593070344154!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47c5e7afa59ae60d%3A0x3f11830627093e83!2sHoofddorp!5e0!3m2!1sfr!2snl!4v1587240275749!5m2!1sfr!2snl"
                    width="100%"
                    height="100%"
                    frameborder="0"
                    style="border:0;"
            ...
            <div class="map-overlay">
                ...
                <v-icon medium class="mb-1 mt-2" color="white">fas fa-phone-alt</v-icon>
                <p>0618874429</p>
            </div>
            </div>
        </v-flex>
        ...
        <v-flex xs12 sm12 md6 lg6 xl6 class="form-flex">
            <h1 class="mb-5 display-2 font-weight-bold"
                data-aos="fade-up"
                data-aos-duration="500"
            >
                Get in touch
            </h1>
            <v-divider width="20%" color="#16032c" style="margin-top:-15px;margin-bottom:20px;"></v-divider>
            <v-form class="mt-5">
                <v-text-field
                    v-model="name"
